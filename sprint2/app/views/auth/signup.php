...
<body>
    <header class="text-center border-bottom p-1">
        <h1>Orion Cadastre-se</h1>
    </header>
    <main class="d-flex justify-content-center align-items-center" style="height: calc(100vh - 65px);">
    <form action="../../auth/signup.php" method="POST" class="text-center border p-3 rounded">
        ...
        <div>
            ...
            <a href="signin.php" class="btn btn-info form-control">Faça login</a>
        </div>
    </form>
    </main>
</body>
